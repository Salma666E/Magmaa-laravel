...
<body>
    <div class="page-wrapper bg-dark p-t-100 p-b-50">
      ...
      <form action="{{url('meeting/ToInsertMeetingArabicword' )}} "method="post">  
      {{csrf_field()}}
      <!--
      <div class="form-row">
                <div class="value">
      ...
      <option value="{{$Commissions->id}}" id="{{$Commissions->id}}" name="{{$Commissions->id}}">{{$Commissions->name}}</option>
        ...
        <input class="btn btn-green"  style="background-color:maroon" type="submit" value=" ادخل الكلمات">
