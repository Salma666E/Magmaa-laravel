...
<div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
      ...
      @if($errors->any())
        ...
        @endif
      <form action="{{url('/word/movetoabsence')}} "method="post" enctype="multipart/form-data">
      {{csrf_field()}}
      <div class="input-group">
   <!--   <label for="commission"></label>-->
        <input  hidden type="text" class="input--style-2"  id="commission" name="commission"  value="{{$c}}">
      </div>
    ...
    <!--  <label for="commission"></label>-->
      ...
      <div class="input-group">
        ...
        <input type="text" class="input--style-2" id="english_word" name="english_word"  value="{{old('english_word')}}">
        </div>
      <div class="input-group">
      ...
      <div class="input-group">
        ...
        <input class="btn btn-block btn-success"  style="background-color:black" type="submit" value="التالى"> </input>
      </form>
      </div>
            </div>
        </div>
